# Question bank – sync-audit instrukcji (aktywny wywiad)
...
- komendy / komponenty / MCP → instrukcje (AGENTS/CLAUDE/GEMINI) + `project.yaml` jeśli to źródło prawdy,
...
Po odpowiedziach: aktualizuję instrukcje (i `project.yaml`, jeśli to źródło prawdy) oraz dopisuję wyjątki/bezpieczeństwo do `additional-contexts.md`.
