# 20260212-1340-workspace-bootstrap_proposal – bootstrap workspace
...
- Wygenerowano: `2026-02-12 13:40`
- project.name: `frontend-only`
- project.structure: `monorepo`

### Komponenty (z configu)
- `gui`: katalog=`gui` (istnieje: OK)

### Komendy / uruchomienie (do potwierdzenia)
- Uwaga: na tym etapie bazujemy na `project.yaml` i prostych checkach plików (Makefile/package.json).
- INIT-02: docelowo ten fragment ma być wspierany analizatorem Makefile (stabilny JSON + sugestie targetów).

### Open questions (do dopisania/uzgodnienia)
- [ ] `gui`: brak `package.json` w `gui/` – czy to faktycznie frontend JS/TS?
