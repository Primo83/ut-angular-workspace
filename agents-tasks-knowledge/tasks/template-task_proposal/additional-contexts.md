# <ID-Z>_proposal - kontekst zadania

> Po skopiowaniu do `tasks/<ID-Z>_proposal/` zmień tytuł (bez słowa „template”), uzupełnij sekcje i usuń podpowiedzi w kursywie, gdy nie są już potrzebne.
